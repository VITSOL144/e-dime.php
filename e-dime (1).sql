...
--
-- Хост: 127.0.0.1
-- Время создания: Май 24 2021 г., 14:37
...
(16, 'Лыжня РАНХИГС', 'Магнитогорсая', '2021-06-03', '16:50:00', 15, 1),
...
INSERT INTO `files` (`id`, `users_id`, `filename`) VALUES
(1, 60, 'ski (2).jpg'),
(4, 63, '1.jpg');
...
(59, 'Виталий', '24', '83a5a282f092aa7baf6982b54227bb54', '89819501577', '2021-04-29', 'Поселок Свердлова', 6),
(60, 'Петр Булкин', 'bool', 'cce38b10c55ddce7f4d5fac9f8e86003', '123', '2021-05-31', 'Санкт-Петербург', 6),
(63, 'Мишка', 'm', '3cfd436919bc3107d68b912ee647f341', '123', '2021-04-26', 'Гатчина', 6);
...
--
ALTER TABLE `files`
  ADD CONSTRAINT `files_ibfk_1` FOREIGN KEY (`users_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
